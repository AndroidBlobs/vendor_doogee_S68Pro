...
BOOT_LOGO = e977_dg_m11_71_p0_eea_fhd1080x2280
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_MTK_SDK =
...
CUSTOM_MODEM=e977_vsim_71_p0_lwtg
...
ODM_FEATURE_FAKE_MAIN3_CAMERA_SUPPORT=yes
...
#otg
CUSTOM_KERNEL_OTG = yes

#notificationLight
CUSTOM_KERNEL_NOTIFICATION_LIGHT = no
...
#Camera
CUSTOM_HAL_IMGSENSOR = imx230_mipi_raw imx230sunny_mipi_raw s5k3p3sx_mipi_raw gc0310_mipi_yuv gc8034_mipi_raw ov16880_mipi_raw gc5035_mipi_raw
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = gc0310_mipi_yuv
CUSTOM_HAL_MAIN_IMGSENSOR = imx230_mipi_raw imx230sunny_mipi_raw
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_IMGSENSOR = s5k3p3sx_mipi_raw ov16880_mipi_raw gc5035_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = gc8034_mipi_raw

CUSTOM_KERNEL_IMGSENSOR = imx230_mipi_raw imx230sunny_mipi_raw s5k3p3sx_mipi_raw gc0310_mipi_yuv gc8034_mipi_raw ov16880_mipi_raw gc5035_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = gc0310_mipi_yuv
CUSTOM_KERNEL_MAIN_IMGSENSOR = imx230_mipi_raw imx230sunny_mipi_raw
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k3p3sx_mipi_raw ov16880_mipi_raw gc5035_mipi_raw
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR = gc8034_mipi_raw


#Lens
CUSTOM_HAL_LENS = dw9800af dummy_lens
CUSTOM_HAL_MAIN_LENS = dw9800af
...
CUSTOM_KERNEL_MAIN_LENS = dw9800af
...
#Finger
WTK_FINGERPRINT_HARDWARE_SUPPORT = yes
FINGERPRINT_FPSENSOR_TRUSTKERNEL_TEE = yes
...
WTK_BUILD_VERNO = DOOGEE-S68Pro-Android9.0-20191031
WTK_INTERNAL_BUILD_VERNO = E977_DG_M11_71_P0_EEA_MP_V1.0.8_S191217

#End For Common----------------------------------------------------------}

#add BUG_ID:E977  EJQQ-106 peng.zhao eea start
HOME_BUTTON_ANIMATION_SUPPORT=yes
#add BUG_ID:E977 EJQQ-106 peng.zhao eea end

#WtkDeskClock
WTK_DESKCLOCK_SUPPORT = yes

# add by liutao for  EJQQ-32 20190828 start
WTK_TARGET_BOARD_NAME = E977
WTK_BASEBAND_VERSION = DOOGEE-S68Pro.20190828
WTK_KERNEL_VERSION = DOOGEEinfo@doogee.cc20190828
WTK_PTP_LABEL = S68 Pro
WTK_MTP_LABEL = S68 Pro
# add by liutao for  EJQQ-32 20190828 end

# add by liutao for YWSW-306 EJQQ-64 20190828 start
WTK_STRESS_TEST = yes
WTK_TOOL_BOX_SUPPORT = yes
# add by liutao for YWSW-306 EJQQ-64 20190828 end

#add by wangjian for EJQQ-63 20190828 start
WTK_DEFAULT_MTP = true
#add by wangjian for EJQQ-63 20190828 end


#FACE_UNLOCK_SUPPORT start
FACE_UNLOCK_SUPPORT = true
FACE_WHEATEK_WITH_ICON = yes
...
ODM_ADUPS_FOTA_DEVICE=EEA
#adupsfota end

SKYROAM_VSIM_SUPPORT = yes

CUSTOM_DG_RINGTONES = yes
REMOVE_BAIDULOCATION = yes
CHROME_CUSTOMIZATIONS_PACKAGES = yes
#add by wangjian for EJQQ-66 20190829 start
WTK_SMART_NAVIBAR_SUPPORT = yes
#add by wangjian for EJQQ-66 20190829 end

# debuid:AQWL-44 add chenxuanyu start 
ODM_SIDE_KEY_SUPPORT = yes
# debuid:AQWL-44 add chenxuanyu end 

# A: add Cyee Camera chenchunyong 20190816 {
CY_CAMERA_FEATURE_SUPPORT = yes

CY_CHENYEE_FEATURE_SUPPORT = yes
CY_CHENYEE_LIVEEFFECT_SUPPORT = yes
CY_CHENYEE_MARKEFFECT_SUPPORT = no
CY_CHENYEE_SCENE_DETECTION_SUPPORT = no

CY_OMRON_FEATURE_SUPPORT = yes
CY_OMRON_BEAUTY_SUPPORT = yes

CY_MORPHO_FEATURE_SUPPORT = yes
CY_MORPHO_FACE_BOKEH_SUPPORT = no
CY_MORPHO_SINGLE_BOKEH_SUPPORT = yes
CY_MORPHO_LOWLIGHT_SUPPORT = yes
CY_MORPHO_HDR_SUPPORT = yes

WTK_CAMERA_APP_SUPPORT = yes
WTK_CAMERA_APP_PLUGIN_FACEBEAUTY_SUPPORT = yes
WTK_CAMERA_APP_PLUGIN_HDR_SUPPORT = yes
WTK_CAMERA_APP_PLUGIN_NIGHT_SUPPORT = yes
WTK_CAMERA_APP_PLUGIN_PANORAMA_SUPPORT = yes
WTK_CAMERA_APP_PLUGIN_PROSETTING_SUPPORT = yes
WTK_CAMERA_APP_PLUGIN_TIMELAPSE_SUPPORT = yes
WTK_CAMERA_APP_PLUGIN_SLOWMOTION_SUPPORT = yes
WTK_CAMERA_APP_PLUGIN_EDITOR_SUPPORT = no
WTK_CAMERA_APP_PLUGIN_GIFSHOT_SUPPORT = yes
WTK_CAMERA_APP_PLUGIN_PICNOTE_SUPPORT = no
WTK_CAMERA_APP_PLUGIN_SCAN_SUPPORT = yes
WTK_CAMERA_APP_PLUGIN_POLAROID_SUPPORT = yes
WTK_CAMERA_APP_PLUGIN_CARD_SUPPORT = no
WTK_CAMERA_APP_PLUGIN_TRANSLATION_SUPPORT = no
WTK_CAMERA_APP_PLUGIN_SELFIEPANORAMA_SUPPORT = no
WTK_CAMERA_APP_PLUGIN_LIVEPHOTO_SUPPORT = yes
WTK_CAMERA_APP_PLUGIN_WIDEANGLE_SUPPORT = yes
WTK_CAMERA_APP_PLUGIN_BOKEH_SUPPORT = yes
# A: }

# Add by HZH on 2019/9/3 for  start
ODM_CYEEFRAMEWORK_SUPPORT = yes
CYEE_FLASHLIGHT_SUPPORT = yes
ODMCALCULATOR_SUPPORT = yes
CYEE_DIALER_INCALL_CONTACTS = yes
# Add by HZH on 2019/9/3 for  end

# add by wangjian for EJWJ-184 20190703 start
CYEE_WEATHER_SUPPORT = yes
# add by wangjian for EJWJ-184 20190703 end

# Add by donghao  2019/8/28 for EJSLY-344 start
CYEE_NOTE_SUPPORT = no
# Add by donghao  2019/8/28 for EJSLY-344 end

# Add by donghao  2019/8/28 for EJSLY-344 end
#add by liulei for CyeeSystemUI 20190617 start
SUPPORT_CYEE_SYSTEMUI = yes
#add by liulei for CyeeSystemUI 20190617 end

#add bug:EJQQ-184 wushanfei 20190905 start
WTK_INSTALL_CYEE_LAUNCHER = yes
#add bug:EJQQ-184 wushanfei 20190905 end

#add audio aw87329 algorithm
WTK_AW87329_ALGORITHM=yes

#add by liulei for EJQQ-269 20190917 start
WTK_CAMERA3_NOT_SUPPORT_IMAGE = yes
#add by liulei for EJQQ-269 20190917 end

#add by liulei for EJQQ-1663 20191112 start
WTK_MOCK_FINGERPRINT = DOOGEE/S68Pro_EEA/S68Pro:9/P00610/1572524041:user/release-keys
WTK_MOCK_DESC = S68Pro_EEA-user 9 P00610 1572524041 release-keys
WTK_BUILD_INCREMENTAL = 1572524041
#add by liulei for EJQQ-1663 20191112 end